...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<fog-ecloud>.freeze, ["= 0.1.1"])
      s.add_runtime_dependency(%q<fog-google>.freeze, [">= 0.0.2"])
      ...
      s.add_dependency(%q<fog-ecloud>.freeze, ["= 0.1.1"])
      s.add_dependency(%q<fog-google>.freeze, [">= 0.0.2"])
